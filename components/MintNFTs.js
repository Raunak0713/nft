        ...
        <>
            <div className="my-11">
                ...
                <div className="grid items-center grid-cols-4 gap-5 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1">
                    {[dummyNFTs,dummyNFTs,dummyNFTs,dummyNFTs,dummyNFTs,dummyNFTs,dummyNFTs,dummyNFTs].map((val, ind) => {
                        return (
                            <div key={ind} className="border border-slate-700 rounded-lg grid items-center">
                                ...
                                <button type="button" className="text-base sm:text-sm w-full py-1.5 bg-gradient-to-br from-pink-600 to-violet-600 rounded-md shadow-md shadow-rose-600 active:scale-90  transition-all">Mint NFTs</button>
                                </div>
                            </div>
                        );
                    })}
