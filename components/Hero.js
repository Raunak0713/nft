    ...
    <>
      <div className="h-[55vh] grid items-center justify-items-center bg-black border border-slate-700 relative rounded-md">
        <div className="grid items-center justify-items-center text-center opacity-100 z-[1700]">
            ...
            let&apos;s enjoy this incredible EtherVault&apos;s  World.</p>
        ...
        <div className="block xxl:hidden h-[54vh] absolute top-1 right-0 rounded-md overflow-hidden opacity-100 z-[1500]">
          <Image src={`https://img.seadn.io/files/4b5e1469b134d0c6cc20a113e34b2c65.jpg?fit=max&auto=format`} alt='hero/ethiconimg' decoding="async" priority width={400} height={450} style={{objectFit: 'fill'}} />
        </div>
      </div>
    </>
  );
