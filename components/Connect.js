      ...
      <>
        <div className="flex items-center justify-center h-[95vh] w-10/12 m-auto lg:w-11/12">
          <div className="grid items-center justify-items-center text-center max-w-3xl">
              ...
              <h1 className="text-6xl md:text-5xl sm:text-4xl font-bold text-slate-300"><span className="font-thin">NFTs</span> You&apos;ll Love</h1>
              <p className="text-base md:text-sm text-slate-500 my-5
              ">I Design Your Dreams. I believe you have a unique taste, discover the possibilities of the NFT World. Mint Your NFTs on the top of Ethereum Blockchain. Your dreams is my first priority. So, let&apos;s enjoy this incredible EtherVault&apos;s World.</p>
